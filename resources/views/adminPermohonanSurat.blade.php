...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Daftar Pengajuan Surat - Admin Penomoran Surat
      </h1>
    </section>
              ...
              <div class="row"><div class="col-sm-12"><table id="example1" class="table table-bordered table-striped  dataTable no-footer" role="grid" aria-describedby="example1_info">
                  ...
                  <tbody>
                      ...
                      @foreach($status as $surat)
                       @if($surat->statuss == 'Sudah Di tanda tangani')       
                        ...
                        <td>{{ $surat->statuss}}</td>
                        <td><a href="{{ route('penomoran.status',['id_prosess'=>$surat->id_prosess,'statuss'=>$surat->statuss]) }}" class="btn btn-warning btn-sm">Dapat Diambil</a></td>
                        </tr>
                       @endif
                      @endforeach
