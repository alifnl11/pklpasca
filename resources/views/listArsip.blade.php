  ...
  <div class="content-wrapper">
    ...
    <section class="content">
        ...
        <div class="box border-top-solid">
            ...
            <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer"><div class="col"><div class="col-sm-4">
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"> + Tambah Arsip Baru</button>
              </div>
              </div>
              </div>
            <div class="col-6">
              <div id="example1_filter" class="dataTables_filter" style=" float: right; padding-right: 20px; position: relative;">
              
              <a href="live_search" class="btn btn-default">Temukan Arsip</a>
            </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content" >
              <div class="modal-header popupheader">
                <h3 class="modal-title" id="exampleModalLabel">Input Data Arsip</h3>
